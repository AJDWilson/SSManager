...
function updateGridStroke() {
  ...
  const minGridWidth = baseSize * 0.001;
  const minBorderWidth = baseSize * 0.001;
  path.setAttribute('stroke-width', Math.max(gridWidthUnits, minGridWidth));
  background.setAttribute('stroke-width', Math.max(borderWidthUnits, minBorderWidth));
}
